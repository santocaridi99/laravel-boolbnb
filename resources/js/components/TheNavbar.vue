          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <form class="d-flex" autocomplete="off">
              <div class="autocomplete">
                ...
                <a class="btn btn-outline-light" @click="filterApartments()">Search</a>
              </div>
            </form>
        </ul>
  ...
  methods: {
    ...
    filterApartments(){
      ...
      if(this.coordinates){
        ...
        axios.get(`https://api.tomtom.com/search/2/search/${address}.json?limit=5&countrySet=IT&radius=20000&language=it-IT&minFuzzyLevel=2&maxFuzzyLevel=2&view=Unified&relatedPois=off&key=${key}`).
        then((response) => {
            response.data.results.forEach(element => {
              if(this.coordinates.length > 10){
                this.coordinates=[];
                this.coordinates.push(element.address.freeformAddress);
