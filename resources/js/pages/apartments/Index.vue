        ...
        <!-- <div class="row g-0 d-flex justify-content-center flat_row"> -->
            ...
            <div class="back_ap">
                ...
                <div class="row flat_row g-0">
                    <div class="col-xxl-3 col-lg-4 col-md-12 col-sm-12 px-3 mb-5" v-for="apartment of apartments" :key="apartment.id">
                        <div class="flat">
                            <router-link
                            class="w-100 ex"
                            :to="`/apartments/${apartment.slug}`">
                            <img class="blk_op_bg w-100 obj_fit show_img" :src="apartment.cover" alt="Flat Cover" />
                            </router-link>
                            ...
                            <div class="ap_body">
                                ...
                                <div class="py-3 px-3 w-100 blk_op_bg">
                                    <div class="ap_title me-2 ms-3 text-break">
                                        ...
                                        <small>
                                            <!-- stanze -->
                                            <span v-if="apartment.room_numbers === 1" class="text-white">
                                            ...
                                            <!-- letti -->
                                            <span v-if="apartment.bed_numbers === 1" class="text-white">
                                                    {{apartment.bed_numbers}} letto &#10022; 
                                            </span>
                                            <span v-else class="text-white">
                                                    {{apartment.bed_numbers}} letti &#10022; 
                                            </span>
                                            <!-- bagni -->
                                            <span v-if="apartment.bathroom_numbers === 1" class="text-white">
                                        ...
                                        <!-- {{-- tags --}} -->
                                <div class="bg-light text-center border py-4 pt-3 tags_container">
                                    <!-- {{-- icons --}} -->
                                    <span
